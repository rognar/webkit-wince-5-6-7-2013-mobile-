...
bool SharedBitmap::ensureHandle()
{
    ...
    BitmapInfo bmpInfo;
    void* pixels;
    m_hbitmap = createHandle(&pixels, &bmpInfo, -1, /*!hasAlpha()*/is16bit());
...
PassOwnPtr<HBITMAP> SharedBitmap::clipBitmap(const IntRect& rect, bool useAlpha, BitmapInfo& bmpInfo, void*& pixels)
{
    ...
    bmpInfo = BitmapInfo::createBottomUp(IntSize(copyWidth, copyHeight), is32bit() /*(useAlpha && is32bit())*/ ? BitmapInfo::BitCount32 : BitmapInfo::BitCount16);
...
PassRefPtr<SharedBitmap> SharedBitmap::clipBitmap(const IntRect& rect, bool useAlpha)
{
    ...
    RefPtr<SharedBitmap> newBmp = create(IntSize(copyWidth, copyHeight), /*useAlpha && is32bit()*/ is32bit() ? BitmapInfo::BitCount32 : BitmapInfo::BitCount16, false);
                        ...
                        const FloatPoint& phase, ColorSpace styleColorSpace, CompositeOperator op, const FloatRect& destRect, const IntSize& origSourceSize)
{
    ...
    BitmapInfo bmpInfo = BitmapInfo::createBottomUp(IntSize(srcRectWin.right, srcRectWin.bottom), /*useAlpha*/ is32bit() ? BitmapInfo::BitCount32 : BitmapInfo::BitCount16);
    void* pixels;
