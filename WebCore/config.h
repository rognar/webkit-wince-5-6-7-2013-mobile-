...
#if PLATFORM(WIN) && !OS(WINCE) && !defined(ENABLE_WINCEONWINDOWS)
...
#define _WINSOCKAPI_ // Prevent inclusion of winsock.h in windows.h
#endif
#elif !OS(WINCE) && !defined(ENABLE_WINCEONWINDOWS)
#define WTF_USE_CG 1
#undef WTF_USE_CAIRO
#undef WTF_USE_CURL
#endif
...
#if OS(WINCE) || defined(ENABLE_WINCEONWINDOWS)
...
int SetGraphicsModeCE(HDC hdc, int iMode);
#define SetGraphicsMode SetGraphicsModeCE

int GetGraphicsModeCE(HDC hdc);
#define GetGraphicsMode GetGraphicsModeCE

void GdiFlushCE();
#define GdiFlush GdiFlushCE


BOOL SetWorldTransformCE(HDC hdc, CONST XFORM *lpXform);
#define SetWorldTransform SetWorldTransformCE

BOOL GetWorldTransformCE(HDC hdc, LPXFORM lpXform );
#define GetWorldTransform GetWorldTransformCE

BOOL ModifyWorldTransformCE(HDC hdc, CONST XFORM * lpxf, DWORD mode);
#define ModifyWorldTransform ModifyWorldTransformCE
