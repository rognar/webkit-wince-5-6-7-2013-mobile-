...
#if WINCE || defined(ENABLE_WINCEONWINDOWS)
...
int SetGraphicsModeCE(HDC hdc, int iMode) {return 1;}
#define SetGraphicsMode SetGraphicsModeCE

int GetGraphicsModeCE(HDC hdc) {return 1;} 
...
BOOL SetWorldTransformCE(HDC hdc, CONST XFORM *lpXform) { return FALSE; }
#define SetWorldTransform SetWorldTransformCE

BOOL GetWorldTransformCE(HDC hdc, LPXFORM lpXform ) { return FALSE; }
#define GetWorldTransform GetWorldTransformCE

BOOL ModifyWorldTransformCE(HDC hdc, CONST XFORM * lpxf, DWORD mode) { return 1; }
